-El codigo es un simulador de gastos diarios, en el cual se puede registrar y almacenar los datos en un archivo .JSON el cual sera leido posteriormente para el calculo total y por categoria de los costos.
